      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            <Grid item xs={6}><TextField label="Full Name" name="fullName" value={formData.fullName} onChange={handleChange} fullWidth required /></Grid>
            ...
            <Grid item xs={6}><TextField label="Age" name="Age" value={formData.Age} onChange={handleChange} fullWidth required /></Grid>
            <Grid item xs={6}><TextField label="Gender" name="Gender" value={formData.Gender} onChange={handleChange} fullWidth required /></Grid>
            <Grid item xs={12}>
              <Button onClick={SignUp} type="submit" variant="contained" sx={{  background: "linear-gradient(135deg, rgba(0,136,160,1), rgba(0,191,184,1))",
                  color: "#fff", width: "100%" }}>
                Sign Up
              </Button>
            </Grid>
